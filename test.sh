...
# python dvp_video_consistency.py --max_epoch 50 --input demo/consistency/colorization/goat_input --processed demo/consistency/colorization/goat_processed --task colorization  --output result/colorization
